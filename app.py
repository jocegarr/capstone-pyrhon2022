...
myheading1 = 'Apple Financing Program'
myheading2 = '- Anchor program for the business; continues to show strong progress'
myheading3 = '- From 2020 to 2021 there was a volume increase of 67%',
myheading4 = '- Increase in application submissions show a positive upward trend',
...
app.layout = html.Div([
    ...
    dcc.Tabs(id="tabs-example", value='tab-1-example',
            children=[
                dcc.Tab(label='Volume', value='tab-1-example'),
                dcc.Tab(label='Application Submissions', value='tab-2-example'),
                dcc.Tab(label='Application Activity', value='tab-3-example'),
    ]),
    html.Div([
